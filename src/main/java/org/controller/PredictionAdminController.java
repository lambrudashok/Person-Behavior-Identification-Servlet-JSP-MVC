...
@WebServlet("/predictionadmincontroller")
public class PredictionAdminController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list!=null){
			for(UserInfoModel userInfo:list){
				out.println("<a class='userappinfo' id='userappinfo' href='predictionpostpage.jsp?id="+userInfo.getRegisterid()+"' >"); 

...
@WebServlet("/searchfollowcontroller")
public class SearchFollowController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result=followSer.isAddFollowingUser(registerId,followid);	
		...
		}else out.println("<h4>User Not Found</h4>");
	}
}
